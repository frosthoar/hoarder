...
#                   pathlib.Path("./test_files/sfv/rhash_output_lowercase.sfv")
#               )
...
#                   pathlib.Path("./test_files/rar/winrar_rar4_password.rar"),
#                   password="password",
#               )
...
#                   pathlib.Path(
#                       "./test_files/hnf/[Foobar] Lowercase and Parens - 11 (x264-AC3)(d74b7612).mkv"
#                   )
#               )
